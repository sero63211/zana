...
| T007-builds | `router_opencode_go_deepseek_v4_flash`, thread `019fe603-86a7-7ee2-a8b3-15981062570e`, lead `019fe396-2a2d-7493-ac98-a551ec7e4e1a`, silent | `agent/T007-builds` at `/Users/sero/.codex/worktrees/216c/zana` | `core/zana_core/builds/**`, `core/tests/builds/**`, `T007-builds.md` | active wave | jobs/capability/knowledge/evaluation PASS; spec 13 | focused pytest/Ruff/Pyright; pure lifecycle/cancellation/finalization contracts; no heavy phase execution |
| T007-hardware-test | `router_opencode_go_deepseek_v4_flash`, thread `019fe60d-b3d2-79b0-b44a-152cbdb2fb03`, lead `019fe396-2a2d-7493-ac98-a551ec7e4e1a`, silent | `agent/T007-hardware-test` at `/Users/sero/.codex/worktrees/d795/zana` | `core/tests/hardware/test_providers.py`, `T007-hardware-test.md` | active wave | integrated hardware lane | prove and repair leaked manual MonkeyPatch so the live Apple Silicon probe is order-independent; run focused and full Core gates |
