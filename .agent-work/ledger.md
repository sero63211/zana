...
| T900-build-evaluation-image-execution | `router_opencode_go_deepseek_v4_flash` with `max`, thread `019fe9e0-aeb8-7f83-b6ef-282c28bc811b`, lead `019fe396-2a2d-7493-ac98-a551ec7e4e1a`, silent | `agent/t900-build-evaluation-image-execution` at `/Users/sero/.codex/worktrees/7225/zana`, base `39245af` | dependency-complete persisted build analysis/baseline/approval/candidate evaluation/gates/image finalization plus exact build/image API, necessary DB contracts, focused tests/handoff | active; one exclusive local writer | integrated capability/runtime/knowledge/training/OCI/jobs/artifact/resource/API contracts | focused injected unit/API only; Ruff/format/Pyright/import/diff; lifecycle/transaction/digest/held-out/approval/cancel/restart/redaction/no-promotion review; no broad/live/model/training/app/build |
| T900-desktop-product-flows | `router_opencode_go_deepseek_v4_flash` with `max`, thread `019feac2-2d73-78d2-b40e-de8625e99ad4`, lead `019fe396-2a2d-7493-ac98-a551ec7e4e1a`, silent | `agent/t900-desktop-product-flows` at `/Users/sero/.codex/worktrees/eb61/zana`, base `23b9034` | exclusive `apps/desktop/src/**`, focused source tests and handoff; no src-tauri/manifests/locks/Core | active; one exclusive local writer | integrated desktop shell/models; documented frozen Core contracts | focused Vitest/TypeScript/ESLint and direct UX/resource review only; no app/browser/build/install/live |
| T900-runtime-native-tools | `router_opencode_go_deepseek_v4_flash` with `max`, thread `019feac3-43a7-7bb0-95e7-8ff70256c72e`, lead `019fe396-2a2d-7493-ac98-a551ec7e4e1a`, silent | `agent/t900-runtime-native-tools` at `/Users/sero/.codex/worktrees/4a35/zana`, base `23b9034` | exact runtime inference/Ollama/OpenAI-compatible files/tests and handoff | active; one exclusive local writer | bounded inference + trusted calculator/tool contracts | focused injected transport tests; Ruff/format/Pyright/import/diff; no live runtime/model/network |
| T900-instance-chat-memory-api | `router_opencode_go_deepseek_v4_flash` with `max`, thread `019feac3-b7cc-7d11-bf78-baa239c76566`, lead `019fe396-2a2d-7493-ac98-a551ec7e4e1a`, silent | `agent/t900-instance-chat-memory-api` at `/Users/sero/.codex/worktrees/dd50/zana`, base `23b9034` | instances/memory plus new isolated API/service/schema files/tests/handoff; shared main/API/DB files excluded | active; one exclusive local writer | persisted image/instance/memory schema and runtime/retrieval/tool foundations | focused injected unit/router tests; Ruff/format/Pyright/import/diff; no live model/runtime/API/app |
| T900-portability-product-api | `router_opencode_go_deepseek_v4_flash` with `max`, thread `019feac4-2564-7b73-8a90-7f7b58f24005`, lead `019fe396-2a2d-7493-ac98-a551ec7e4e1a`, silent | `agent/t900-portability-product-api` at `/Users/sero/.codex/worktrees/8037/zana`, base `23b9034` | portability plus new isolated API/service/schema files/tests/handoff; images/shared main/API/DB excluded | active; one exclusive local writer | integrated OCI/archive/import/security and artifact registry | focused tiny archive/injected API tests; Ruff/format/Pyright/import/diff; no large/live/install/broad tests |
| T910-desktop-frontend-program | `gpt-5.6-sol` with `high`, thread/worktree pending, lead `019fe396-2a2d-7493-ac98-a551ec7e4e1a`, silent | reserved branch `agent/t910-desktop-frontend-program`; isolated local worktree pending | new files only under `docs/desktop-frontend-program/**` plus `T910-desktop-frontend-program.md`; every existing file and all product code excluded | queued; docs/design program only | controlling spec, acceptance, canonical code/contracts/tests, current primary sources | source-backed blueprint/contract ledger/Kimi Gold Prompt/goal launcher; no code/live model/heavy test/build/deploy/stage/commit/push |
