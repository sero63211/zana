...
| T900-global-jobs-product-api | `router_opencode_go_deepseek_v4_flash` with `max`, thread `019feb66-e32a-7c51-846c-9a5c66070666`, lead `019fe396-2a2d-7493-ac98-a551ec7e4e1a`, silent | `agent/t900-global-jobs-product-api` at `/Users/sero/.codex/worktrees/c1fc/zana`, base `2f283cb` | exact jobs API/services plus isolated job query/schema files and focused tests/handoff; shared main/schema/DB/acquisition/build/instance/desktop excluded | active; one exclusive local writer | persisted jobs/events, model-pull cancellation and authenticated bounded SSE | focused auth/pagination/filter/cursor/projection/redaction/cancel-idempotency tests plus Ruff/format/Pyright/import/diff; no live/broad/model/app |
