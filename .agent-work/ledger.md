...
| T921-rust-operational-core | `router_opencode_go_deepseek_v4_flash` with `max`, thread `019ff17c-9aad-7af1-8e9c-c330b19a4275`, lead `019fe396-2a2d-7493-ac98-a551ec7e4e1a`, silent | isolated worktree `/Users/sero/.codex/worktrees/1668/zana`, exact clean pushed base/reservation `8c11ac4`; worker must switch detached setup to `agent/t921-rust-operational-core` before writes | exclusive shared Rust operational plane and compatibility routes/tests; capability lifecycle, Python/TS/Tauri/Android/state/ledger excluded | active visible implementation; preflight/contract mapping in progress; no push | accepted Python operational contracts plus T920 Rust foundation | injected/focused Rust only; no live runtime/model/provider/network/download/app/device/broad |
| T921B-rust-compatibility-api | `router_opencode_go_deepseek_v4_flash` with `max`, thread `019ff24f-7688-7153-926e-68c09175e299`, lead `019fe396-2a2d-7493-ac98-a551ec7e4e1a`, silent | reserved `agent/t921b-rust-compatibility-api`; isolated local worktree `/Users/sero/.codex/worktrees/0b16/zana` from canonical `bf46c8c` | only `crates/zana-core-server/**` plus exact new handoff; every shared core/other path excluded | active visible Phase A implementation; no push | accepted canonical DB/jobs/resources/doctor/runtime/settings modules; acquisition/observability later serial inputs | focused Rust server/router tests only; no external/live/model/runtime/provider/download/app/broad |
...
| T922D-rust-build-planner | `router_opencode_go_deepseek_v4_flash` with `max`, visible task pending creation, lead `019fe396-2a2d-7493-ac98-a551ec7e4e1a`, silent | reserved `agent/t922d-rust-build-planner`; local isolated worktree pending | new standalone `crates/zana-build/**` plus exact handoff only; every existing/shared path excluded | reserved; no writes/no push | accepted capability analysis/build/training/resource contracts; later serial T922 integration | focused standalone Rust only; no provider/model/dataset/filesystem/network/process/training/app/device/root-workspace/broad |
| T922E-rust-permission-engine | `router_opencode_go_deepseek_v4_flash` with `max`, visible task pending creation, lead `019fe396-2a2d-7493-ac98-a551ec7e4e1a`, silent | reserved `agent/t922e-rust-permission-engine`; local isolated worktree pending | new standalone `crates/zana-permissions/**` plus exact handoff only; every existing/shared path excluded | reserved; no writes/no push | accepted permissions/tools plus Android safety contract; later serial T922/T923 integration | focused standalone Rust only; no OS action/accessibility/filesystem/network/process/model/provider/app/device/root-workspace/broad |
| T922F-rust-instance-memory | `router_opencode_go_deepseek_v4_flash` with `max`, visible task pending creation, lead `019fe396-2a2d-7493-ac98-a551ec7e4e1a`, silent | reserved `agent/t922f-rust-instance-memory`; local isolated worktree pending | new standalone `crates/zana-memory/**` plus exact handoff only; every existing/shared path excluded | reserved; no writes/no push | accepted mutable Instance conversation/memory/provenance/privacy contracts; later serial T922 integration | focused standalone Rust only; no persistence/filesystem/network/model/provider/inference/app/device/root-workspace/broad |
