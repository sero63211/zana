...
| T900-capability-authoring-api | `router_opencode_go_deepseek_v4_flash` with `max`, thread `019fe8b6-af8f-76e1-b818-49a3dccebd47`, lead `019fe396-2a2d-7493-ac98-a551ec7e4e1a`, silent | `agent/t900-capability-authoring-api` at `/Users/sero/.codex/worktrees/f2c9/zana`, base `48a016c` | complete capability draft/source/reopen/validation API vertical and focused tests/handoff | worker complete; lead review pending | canonical capability/source validator and existing authenticated route contract | 46 new focused + 207 owned-surface tests; Ruff/format/Pyright/import/diff; no build/training/model/live execution |
| T900-mlx-training-execution | `router_opencode_go_deepseek_v4_flash` with `max`, thread `019fe8bb-fe02-7340-97c5-fa915f4ba840`, lead `019fe396-2a2d-7493-ac98-a551ec7e4e1a`, silent | `agent/t900-mlx-training-execution` at `/Users/sero/.codex/worktrees/3858/zana`, base `87e10a8` | complete real MLX-LM invocation/staging/executor/adapter-verification vertical and focused tests/handoff | worker finalization active | canonical training identities/datasets/resources/cancellation; official current mlx_lm.lora CLI | injected-process code only; held-out isolation and bounded failure cleanup; no MLX import/process/model/training run |
...
| T900-model-acquisition-execution | `router_opencode_go_deepseek_v4_flash` with `max`, thread `019fe8d9-c4a2-7bd3-ba23-c86baeb37ce8`, lead `019fe396-2a2d-7493-ac98-a551ec7e4e1a`, silent | `agent/t900-model-acquisition-execution` at `/Users/sero/.codex/worktrees/4a22/zana`, base `51c08ad` | real native model-acquisition transport/supervisor, persisted jobs/progress/cancel/recovery, shared discovery service, model/job/runtime API wiring, focused tests/handoff | active | integrated runtime/model API, acquisition contracts, persistent job/SSE lifecycle | injected transport only; no live runtime/network/model/download; no capability/training/shared schema ownership |
