...
| T007-portability | `router_opencode_go_deepseek_v4_flash` with `max`, thread `019fe78f-c167-7b83-924b-a533cf01ed6b`, lead `019fe396-2a2d-7493-ac98-a551ec7e4e1a`, silent | detached recovery worktree `/Users/sero/.codex/worktrees/438c/zana`, source `agent/T007-portability@17fe218` | portability package/tests plus single-owner canonical image archive/OCI/import/secrets files and image tests, `T007-portability.md` | active recovery; lead rerun is red at 215 PASS / 2 FAIL and returned to writer | artifact/image PASS; specs 08/17; strict lightweight owner constraint | repair cumulative import-budget and export-fsync failure gates; rerun all focused gates; no integration while red |
