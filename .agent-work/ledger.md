...
| T005-contracts | `router_opencode_go_deepseek_v4_pro` | isolated worktree assigned at activation | `core/zana_core/domain/**`, `core/zana_core/db/**`, `core/zana_core/jobs/**`, backend API/schema integration, focused tests, `T005.md` | active | T004 PASS; specs 03/08/09/13/18/19 | typed entities/enums; SQLite WAL/FK/migrations; repositories; real job/event persistence; contract tests |
